...
@section('content')
    ...
    <article>
        <div class="banner">
            <ul class="texts">
                <p>What is destinied to be yours would be yours,those that aren't, no matter how hard you try the outcome won't change.</p>
                <p>命里哊时终须有 命里无时莫强求 。</p>
            </ul>
        </div>
        <div class="bloglist">
            ...
            <div class="blogs">
                ...
                <figure><img src="{{$v->cover}}" ></figure>
                <ul>
                    {{htmlspecialchars($v->content)}}
                    <a href="/" target="_blank" class="readmore">阅读全文&gt;&gt;</a>
                </ul>
                <p class="autor"><span>作者：{{$v->author}}</span><span>分类：【<a href="/">日记</a>】</span><span>浏览（<a href="/">{{$v->browse}}</a>）</span><span>评论（<a href="/">{{$v->comment}}</a>）</span></p>
            ...
            {{--<div class="blogs">--}}
                ...
                {{--<figure><img src="{{asset('blog/images/01.jpg')}}" ></figure>--}}
                {{--<ul>--}}
            ...
            {{--<div class="blogs">--}}
                ...
                {{--<figure><img src="{{asset('blog/images/02.jpg')}}" ></figure>--}}
                {{--<ul>--}}
            ...
            {{--<div class="blogs">--}}
                ...
                {{--<figure><img src="{{asset('blog/images/03.png')}}" ></figure>--}}
                {{--<ul>--}}
            ...
            {{--<div class="blogs">--}}
                ...
                {{--<figure><img src="{{asset('blog/images/04.jpg')}}" ></figure>--}}
                {{--<ul>--}}
            ...
            {{--<div class="blogs">--}}
                ...
                {{--<figure><img src="{{asset('blog/images/04.png')}}" ></figure>--}}
                {{--<ul>--}}
...
@section('aside')
    <aside>
        <div class="avatar"><a href="about.html"><span>关于我的</span></a></div>
